...
function topBar({navigation, route}) {
  ...
  return (
    ...
    <View style={styles.topBar1}>
        <View style={{width: 50}}>
            <IconButton Material={true} color={globalColors.background1} size={34} icon='arrow-back-ios' onPress={()=>navigation.navigate("Listings", {mainCat: route.params.mainCat, backData: route.params.backData, parent: route.params.parent})}/>
        </View>
